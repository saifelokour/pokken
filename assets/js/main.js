...
var _user$project$Main$exampleTab = _elm_lang$html$Html$text('Hello');
var _user$project$Main$aboutTab = _elm_lang$html$Html$text('World');
var _user$project$Main$model = {tab: 0, mdl: _debois$elm_mdl$Material$model};
		...
		A6(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Icon$i('favorite'),
						_1: {
							ctor: '::',
							_0: A2(
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('About tabs'),
								_1: {ctor: '[]'}
							}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Icon$i('done'),
							_1: {
								ctor: '::',
								_0: A2(
									_debois$elm_mdl$Material_Options$span,
			...
			},
			{
				...
				_0: function () {
					var _p1 = model.tab;
					if (_p1 === 0) {
						return _user$project$Main$aboutTab;
					} else {
						return _user$project$Main$exampleTab;
					}
				}(),
				_1: {ctor: '[]'}
			}));
